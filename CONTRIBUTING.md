# Contributing to Unified Measurement Ontology

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
Unified Measurement Ontology. These guidelines are not strict rules.
...
The Unified Measurement Ontology team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the Unified Measurement Ontology technical leads
...
[issues]: https://github.com/sierra-moxon/Unified Measurement Ontology/issues/
[pulls]: https://github.com/sierra-moxon/Unified Measurement Ontology/pulls/
